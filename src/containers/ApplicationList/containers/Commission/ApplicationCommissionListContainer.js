...
import { applicationCommissionAllFetchList } from '../../actions'

// Enhance
const enhance = compose(connect())
const getRoomListParams = () => ({
  action: applicationCommissionAllFetchList,
  stateName: STATE.APPLICATION_LIST,
  pickParams: [...DEFAULT_PICK_PARAMS, ...fields]
})

const ApplicationCommissionListContainer = props => {
...
export default enhance(ApplicationCommissionListContainer)
