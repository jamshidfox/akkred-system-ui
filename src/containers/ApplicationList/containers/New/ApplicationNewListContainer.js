...
import { applicationFetchAllList } from '../../actions'

// Enhance
const enhance = compose(connect())
const getRoomListParams = () => ({
  action: applicationFetchAllList,
  stateName: STATE.APPLICATION_LIST,
  pickParams: [...DEFAULT_PICK_PARAMS, ...fields]
})

const ApplicationNewListContainer = props => {
...
export default enhance(ApplicationNewListContainer)
