...
import ReAuditOrder from '../../Application/components/ApplicationGenerateDocs/ReAuditOrder'
import ReAuditClientSendDocument from '../../Application/components/ApplicationGenerateDocs/ReAuditClientSendDocument'
...
const ExpertAuditDetail = props => {
  ...
  const planWorks = prop('planWorks', application)

  const planProofWorks = prop('planProofWorks', application)
  ...
  return (
    <BoxUI>
      ...
      {tableDoc}
      <ReAuditClientSendDocument planWorks={planWorks} results={planProofWorks} />
