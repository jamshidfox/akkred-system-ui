    ...
    const moreList = [
      {
        ...
        onClick: () => {
          history.push({
            pathname: sprintf(ROUTES.RE_AUDIT_EXPERT_UPDATE_URL, id)
          })
        }
      },
    ]
    ...
    return (
      ...
      >
        <td colSpan={6}><a style={{
          color: 'blue'
        }} href={sprintf(ROUTES.RE_AUDIT_EXPERT_UPDATE_URL, id)}>Ariza №{application.id}/{application.registerDate}</a> </td>
