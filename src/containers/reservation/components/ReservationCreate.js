...
import { PageTitle, MediumButton, Modal } from '../../../components/UI'
import {
  Form,
      ...
      <BoxUI>
        <Tabs initialValue={'guest'} value={tabData.tab} onChange={tabData.onTabChange}>
          ...
          <Tab title="СЧЕТ К ОПЛАТЕ" value={'payment'} label={'сЧЕТ К ОПЛАТЕ'}>
            <ReservationPaymentInfo onSubmit={onCreateReservation}/>
          </Tab>
        ...
        <Modal onClose={clientExistingModal.onClose} open={clientExistingModal.open} width={'90%'}>
          <Form
