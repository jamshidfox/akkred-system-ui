...
`
const ConfirmStageAccountingConfirm = ({ onClose, onSubmit, open }) => {
  return (
          ...
          return (
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ textAlign: 'right' }}>
                <MediumButton type="submit">Rahbarga junatish</MediumButton>
              </div>
            </form>
          )
        }}
...
export default ConfirmStageAccountingConfirm
