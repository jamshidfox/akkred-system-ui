...
const getInitialValues = data => {
  const clientInfo = {
    ...
    objectInn: prop('objectInn', data),
    legalEntityName: prop('legalEntityName', data),
    leaderEntityFullName: prop('leaderEntityFullName', data),
  ...
  return {
    ...
    id: prop('id', data),
    deadlineStage: prop('deadlineStage', data),
